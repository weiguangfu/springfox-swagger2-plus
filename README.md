...
[![Build Status](https://travis-ci.org/weiguangfu/springfox-swagger2-plus.svg?branch=2.9.2-1-beta1)](https://travis-ci.org/weiguangfu/springfox-swagger2-plus)
[![Maven central](https://maven-badges.herokuapp.com/maven-central/cn.weiguangfu/springfox-swagger2-plus/badge.svg)](https://search.maven.org/artifact/cn.weiguangfu/springfox-swagger2-plus/2.9.2-1-beta1/jar)
...
### 增强效果如下
![img](image/effect/Swagger2Plus_2.9.2_1.png)
![img](image/effect/Swagger2Plus_2.9.2_2.png)
